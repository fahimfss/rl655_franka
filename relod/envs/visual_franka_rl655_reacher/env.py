...
class FrankaPanda_Visual_Reacher_RL655(FrankaPanda_Visual_Reacher_V0):
    ...
    seed=9, 
    size_tol=0.015):
        super(FrankaPanda_Visual_Reacher_RL655, self).__init__(dt, image_history_size, image_width, 
        image_height, episode_length, camera_index, seed)
    ...
    def step(self, action, pose_vel_limit=0.3):
        ...
        cover = self._compute_target_size(mask) 

        # done = cover >= self._size_tol
