...
from relod.envs.visual_franka_fast_reacher.env import FrankaPanda_Visual_Fast_Reacher
...
def parse_args():
    parser = argparse.ArgumentParser(description='Franka Visual Fast')
    # environment
    parser.add_argument('--setup', default='Visual-Franka')
    parser.add_argument('--env', default='Visual_Franka_Fast', type=str) 
    parser.add_argument('--camera_id', default=4, type=int)
    ...
    parser.add_argument('--episode_length_time', default=5.0, type=float)
    parser.add_argument('--dt', default=(1.0/120.0), type=float)

    parser.add_argument('--size_tol', default=0.4, type=float)
...
def main():
    ...
    env = FrankaPanda_Visual_Fast_Reacher(
    ...
    while not experiment_done:
        ...
        while not experiment_done and not epi_done:
            ...
            if not epi_done and epi_steps >= episode_length_step: # set timeout here
                epi_done = True
