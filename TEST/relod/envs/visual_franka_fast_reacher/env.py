...
class FrankaPanda_Visual_Fast_Reacher(FrankaPanda_Visual_Reacher_V0):
    ...
    seed=9, 
    size_tol=0.015):
        super(FrankaPanda_Visual_Fast_Reacher, self).__init__(dt, image_history_size, image_width, image_height, camera_index, seed)
