...
def parse_args():
    parser = argparse.ArgumentParser(description='Local Franka Visual Synchronous High Resolution')
    # environment
    parser.add_argument('--setup', default='Visual-Franka')
    parser.add_argument('--env', default='franka_visual_reacher_sync_highres', type=str) 
    ...
    parser.add_argument('--dt', default=0.08, type=float)
    ...
    parser.add_argument('--reward_scale', default=2.0, type=float)
    # replay buffer
    parser.add_argument('--replay_buffer_capacity', default=100000, type=int)
    parser.add_argument('--rad_offset', default=0.01, type=float)
    # train
    parser.add_argument('--init_steps', default=2500, type=int) 
    parser.add_argument('--env_steps', default=54000, type=int)
